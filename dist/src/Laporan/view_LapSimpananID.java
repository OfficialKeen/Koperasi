 ...
 * @author KEEN-JAVA
 */
public class view_LapSimpananID extends javax.swing.JDialog {

    private DefaultTableModel model;
    public LapSimpanan LSM = null;
    
    public view_LapSimpananID(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void tblCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCariMouseClicked
        ...
        LSM.No_anggota = tblCari.getValueAt(tbl, 0).toString();
        LSM.Nama = tblCari.getValueAt(tbl, 1).toString();
        LSM.itemTerpilihID();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_LapSimpananID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                view_LapSimpananID dialog = new view_LapSimpananID(new javax.swing.JFrame(), true);
