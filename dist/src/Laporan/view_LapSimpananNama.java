 ...
 * @author KEEN-JAVA
 */
public class view_LapSimpananNama extends javax.swing.JDialog {

    private DefaultTableModel model;
    public LapSimpanan LSN = null;
    
    public view_LapSimpananNama(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void txCariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txCariKeyReleased
        if (rdID.isSelected()){
            ...
            try {
                ...
                ResultSet res=statement.executeQuery("SELECT No_anggota,Nama FROM t_anggota WHERE No_anggota LIKE '"+txCari.getText()+"%'");
                while (res.next())
                {
        ...
        if (rdNama.isSelected()){
            ...
            try {
                Statement statement=(Statement)Koneksi.GetConnection().createStatement();
                ResultSet res=statement.executeQuery("SELECT No_anggota,Nama FROM t_anggota WHERE Nama LIKE '"+txCari.getText()+"%'");
                while (res.next())
                {
                    tbl.addRow(new Object[]{
                        res.getString("No_anggota"),
    ...
    private void tblCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCariMouseClicked
        ...
        LSN.No_anggota = tblCari.getValueAt(tbl, 0).toString();
        LSN.Nama = tblCari.getValueAt(tbl, 1).toString();
        LSN.itemTerpilihNama();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_LapSimpananNama.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                view_LapSimpananNama dialog = new view_LapSimpananNama(new javax.swing.JFrame(), true);
