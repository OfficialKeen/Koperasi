 ...
 * @author KEEN-JAVA
 */
public class view_LapAngsurID extends javax.swing.JDialog {

    private DefaultTableModel model;
    public LapAngsur LAD = null;
    public view_LapAngsurID(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void txCariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txCariKeyReleased
        ...
        if (rdNama.isSelected()){
            ...
            try {
                Statement statement=(Statement)Koneksi.GetConnection().createStatement();
                ResultSet res=statement.executeQuery("SELECT kd_pinjaman, No_anggota,Nama FROM t_pinjam WHERE WHERE Nama LIKE '"+txCari.getText()+"%'");
                while (res.next())
                {
                    tbl.addRow(new Object[]{
                        res.getString("kd_pinjaman"),
    ...
    private void tblCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCariMouseClicked
        ...
        LAD.Kd_Angsuran = tblCari.getValueAt(tbl, 0).toString();
        LAD.No_anggota = tblCari.getValueAt(tbl, 1).toString();
        LAD.Nama = tblCari.getValueAt(tbl, 2).toString();
        LAD.itemTerpilihID();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_LapAngsurID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                view_LapAngsurID dialog = new view_LapAngsurID(new javax.swing.JFrame(), true);
