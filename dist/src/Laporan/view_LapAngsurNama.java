 ...
 * @author KEEN-JAVA
 */
public class view_LapAngsurNama extends javax.swing.JDialog {

    private DefaultTableModel model;
    public LapAngsur LAN = null;
    public view_LapAngsurNama(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void txCariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txCariKeyReleased
        if (rdID.isSelected()){
            ...
            try {
                ...
                ResultSet res=statement.executeQuery("SELECT kd_pinjaman, No_anggota,Nama FROM t_pinjam WHERE kd_pinjaman LIKE '"+txCari.getText()+"%'");
                while (res.next())
                {
        ...
        if (rdNama.isSelected()){
            ...
            try {
                Statement statement=(Statement)Koneksi.GetConnection().createStatement();
                ResultSet res=statement.executeQuery("SELECT kd_pinjaman, No_anggota,Nama FROM t_pinjam WHERE Nama LIKE '"+txCari.getText()+"%'");
                while (res.next())
                {
                    tbl.addRow(new Object[]{
                        res.getString("kd_pinjaman"),
    ...
    private void tblCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCariMouseClicked
        ...
        LAN.Kd_Angsuran = tblCari.getValueAt(tbl, 0).toString();
        LAN.No_anggota = tblCari.getValueAt(tbl, 1).toString();
        LAN.Nama = tblCari.getValueAt(tbl, 2).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_LapAngsurNama.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                view_LapAngsurNama dialog = new view_LapAngsurNama(new javax.swing.JFrame(), true);
    ...
    void tampil(){
        ...
        try {
            Statement statement=(Statement)Koneksi.GetConnection().createStatement();
            ResultSet res=statement.executeQuery("SELECT kd_pinjaman,No_anggota, Nama FROM t_pinjam");
            while (res.next()) 
            {
                tbl.addRow(new Object[]{
                    res.getString("kd_pinjaman"),
            ...
            tblCari.getColumnModel().getColumn(1).setPreferredWidth(100);
