 ...
 * @author GHITEEN
 */
public class LapPinjaman extends javax.swing.JDialog {
    
    private SimpleDateFormat frmtgl = new SimpleDateFormat("yyyy-MM-dd");

    public String kd_pinjaman,No_anggota, Nama;
    ...
    public LapPinjaman(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        aturRd(false, true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (rdTampil.isSelected()){
            try {
                String path = System.getProperty ("user.dir") +"/src/Report/LapPinjamAll.jasper";
        ...
        /*if (rdPilihan.isSelected()){
            if(rdID.isSelected()){
                try {
                    String path = System.getProperty ("user.dir") +"/src/Report/LapPinjamID.jasper";
                    //  File file=new File("src/nyobarepotlagi/report1.jrxml");
                    //  JasperDesign jasperdesign=JRXmlLoader.load(file);
                    HashMap parameter = new HashMap();
            ...
            if(rdNama.isSelected()){
                try {
                    String path = System.getProperty ("user.dir") +"/src/Report/LapPinjamNama.jasper";
                    //  File file=new File("src/nyobarepotlagi/report1.jrxml");
                    //  JasperDesign jasperdesign=JRXmlLoader.load(file);
                    HashMap parameter = new HashMap();
        ...
        if (rdRentang.isSelected()){
            try {
                String path = System.getProperty ("user.dir") +"/src/Report/LapPinjamP.jasper";
                //  File file=new File("src/nyobarepotlagi/report1.jrxml");
                //  JasperDesign jasperdesign=JRXmlLoader.load(file);
                HashMap parameter = new HashMap();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LapPinjaman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LapPinjaman dialog = new LapPinjaman(new javax.swing.JFrame(), true);
    ...
    public void itemTerpilihID(){
        view_LapPinjamanID LA = new view_LapPinjamanID(null, rootPaneCheckingEnabled);
        LA.LAP=this;
        txCari.setText(kd_pinjaman);
    }
    
    public void itemTerpilihNama(){
        view_LapPinjamanNama LP = new view_LapPinjamanNama(null, rootPaneCheckingEnabled);
        LP.LAN=this;
        txCari.setText(Nama);
    }*/
}
