...
public class LapSaham extends javax.swing.JDialog {

    private SimpleDateFormat frmtgl = new SimpleDateFormat("yyyy-MM-dd");
    
    public LapSaham(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (rdRentang.isSelected()){
            try {
                String path = System.getProperty ("user.dir") +"/src/Report/LapSahamP.jasper";
                //  File file=new File("src/nyobarepotlagi/report1.jrxml");
                //  JasperDesign jasperdesign=JRXmlLoader.load(file);
                HashMap parameter = new HashMap();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LapSaham.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LapSaham dialog = new LapSaham(new javax.swing.JFrame(), true);
