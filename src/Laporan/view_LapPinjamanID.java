 ...
 * @author KEEN-JAVA
 */
public class view_LapPinjamanID extends javax.swing.JDialog {

    private DefaultTableModel model;
    public LapPinjaman LAP = null;
    public view_LapPinjamanID(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        rdID.setText("Kode");
        jPanel1.add(rdID, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, -1, -1));

        rdNama.setFont(new java.awt.Font("Segoe UI Emoji", 0, 14)); // NOI18N
        rdNama.setText("Nama");
        jPanel1.add(rdNama, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, -1));
    ...
    private void tblCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCariMouseClicked
        ...
        LAP.kd_pinjaman = tblCari.getValueAt(tbl, 0).toString();
        LAP.No_anggota = tblCari.getValueAt(tbl, 1).toString();
        LAP.Nama = tblCari.getValueAt(tbl, 2).toString();
//        LAP.itemTerpilihID();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_LapPinjamanID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                view_LapPinjamanID dialog = new view_LapPinjamanID(new javax.swing.JFrame(), true);
