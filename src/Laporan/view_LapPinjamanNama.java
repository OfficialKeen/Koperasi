 ...
 * @author KEEN-JAVA
 */
public class view_LapPinjamanNama extends javax.swing.JDialog {

    private DefaultTableModel model;
    public LapPinjaman LAN = null;
    public view_LapPinjamanNama(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        rdID.setText("Kode");
        jPanel1.add(rdID, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, 60, -1));
    ...
    private void tblCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCariMouseClicked
        ...
        LAN.kd_pinjaman = tblCari.getValueAt(tbl, 0).toString();
...
//        LAN.itemTerpilihNama();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_LapPinjamanNama.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                view_LapPinjamanNama dialog = new view_LapPinjamanNama(new javax.swing.JFrame(), true);
