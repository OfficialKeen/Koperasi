 ...
 * @author KEEN-JAVA
 */
public class view_LapAnggotaID extends javax.swing.JDialog {

    private DefaultTableModel model;
    public LapAnggota LAP = null;
    
    public view_LapAnggotaID(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void tblCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCariMouseClicked
        ...
        LAP.No_anggota = tblCari.getValueAt(tbl, 0).toString();
        LAP.Nama = tblCari.getValueAt(tbl, 1).toString();
        LAP.itemTerpilihID();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_LapAnggotaID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                view_LapAnggotaID dialog = new view_LapAnggotaID(new javax.swing.JFrame(), true);
