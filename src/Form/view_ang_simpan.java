...
public class view_ang_simpan extends javax.swing.JDialog {

    private DefaultTableModel model;
    public F_Simpanan fAS = null;
    
    public view_ang_simpan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();        
        tampil();
    }
    ...
    private void tblCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCariMouseClicked
        ...
        fAS.No_anggota = tblCari.getValueAt(tbl, 0).toString();
        fAS.Nama = tblCari.getValueAt(tbl, 1).toString();
        fAS.itemTerpilih();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_ang_simpan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                view_ang_simpan dialog = new view_ang_simpan(new javax.swing.JFrame(), true);
